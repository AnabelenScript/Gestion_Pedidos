...
| **Organización y gobierno** | 4 | Hay contratos OpenAPI, PRs, ramas y revisión antes de main | Falta gobierno formal de versiones | Versionar endpoints como `/v1/orders` |
...
2. **Sin versionado formal**: Usar `/v1` en endpoints.
